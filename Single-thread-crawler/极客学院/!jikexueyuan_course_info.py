...
#        f = open('d:\\info.txt','a')
        csvfile = file('d:/tesr.csv','wb')
        write = csv.writer(csvfile)
        write.writerow(['title','content','classtime','classlevel','learnnum'])
...
#           f.writelines('learnnum:' + each['learnnum'] +'\n\n')
            write.writerows([each['title'],each['content'],each['classtime'],each['classlevel'],each['learnnum']])
        csvfile.close()
#        f.close()
